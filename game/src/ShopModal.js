    ...
    return (
      <div>
        ...
        >
          ...
          <h2 className="centered">Welcome to the Hot Rod Computer store</h2>
          <p className="centered">We offer the finest selection of computers, components and of course a special price, just for you my friend!</p>
          <img src={computershoplogo} alt="computershoplogo" className="computershoplogo"/>
          <button onClick={this.props.closeModal} className="modal-close-button">close</button>
